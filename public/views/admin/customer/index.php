                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="detail<?= $c['id'] ?>" aria-labelledby="detailLabel">
                            ...
                            <div class="offcanvas-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" disabled readonly value="<?= $c['nama'] ?>">
                                </div>

                                <div class="mb-3">
                                    <label for="email" class="form-label">Email</label>
                                    <input type="text" class="form-control" disabled readonly value="<?= $c['email'] ?>">
                                </div>

                                <div class="mb-3">
                                    <label for="alamat" class="form-label">Alamat</label>
                                    <textarea type="text" class="form-control" disabled readonly><?= $c['alamat'] ?></textarea>
                                </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form method="post" action="<?= Routes::base('customer/edit') ?>">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                <label for="nama" class="form-label">Nama</label>
                                                <input class="form-control" id="nama" name="nama" value="<?= $c['nama'] ?>" placeholder="Masukkan nama">
                                            ...
                                            <div class="mb-3">
                                                <label for="alamat" class="form-label">Alamat</label>
                                                <textarea class="form-control" id="alamat" name="alamat" placeholder="Masukkan alamat"><?= $c['alamat'] ?></textarea>
                                            ...
                                            <div class="mb-3">
                                                <label for="email" class="form-label">Email</label>
                                                <input class="form-control" id="email" type="email" name="email" value="<?= $c['email'] ?>" placeholder="Masukkan email">
                                            ...
                                            <div class="mb-3">
                                                <label for="notelp" class="form-label">Notelp</label>
                                                <input class="form-control" id="notelp" type="notelp" name="notelp" value="<?= $c['notelp'] ?>" placeholder="Masukkan notelp">
